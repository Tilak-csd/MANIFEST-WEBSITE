...
export default function USA() {
  return (
    <>
        ...
        <HeroSection to='/country/usa' pageName='USA' description='World Class Education, Countless Opportunities' Heading='Study In USA' url='https://ik.imagekit.io/fsso0s4pw/Header/header_banner.webp' />
