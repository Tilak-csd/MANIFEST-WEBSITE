    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 flex h-full flex-col items-center justify-center text-white p-4">
                <h3 className="mb-2 text-2xl md:text-3xl font-bold tracking-tight">
                    Study in {country}
                </h3>

                {/* <Buttons classname={"rounded-none py-1 px-5"} to={to} label={'Learn More'}>
                </Buttons> */}
                <button className='py-2 px-4 cursor-pointer font-semibold bg-red-500 hover:bg-white hover:text-red-500 text-white '>
                    Learn More
                </button>
            </div>
        </div>
