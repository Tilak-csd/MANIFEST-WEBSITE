        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-14 gap-6 mb-8">
          ...
          <div className="lg:col-span-5">
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://wa.me/9851363253" target='_blank' className="hover:bg-black hover:text-white bg-white rounded-full p-2 text-black transition-colors flex items-center justify-center">
                <svg
              ...
              <a href="https://www.tiktok.com/@manifestedu1" target='_blank' className="hover:bg-black hover:text-white bg-white rounded-full p-2 text-black transition-colors flex items-center justify-center">
                <FontAwesomeIcon
                  icon={faTiktok}
                  size="18"
                />
